...
<template:addResources type="javascript" resources="i18n/github-oauth-connector-i18n_${currentResource.locale}.js" var="i18nJSFile"/>
<c:if test="${empty i18nJSFile}">
    <template:addResources type="javascript" resources="i18n/github-oauth-connector-i18n_en.js"/>
</c:if>
...
<md-card ng-controller="GithubController as github">
    ...
    <md-card-content layout="column" ng-show="github.expandedCard">
        <form name="githubForm">
            ...
            <md-switch ng-model="github.isActivate">
            ...
            <div layout="row">
                <md-input-container class="md-block" flex>
                    ...
                    <md-icon class="md-icon-button" ng-click="github.addUrl(githubForm.callbackUrl.$valid)">add</md-icon>
            ...
            <div layout="row" ng-show="github.callbackUrls.length > 0">
                <md-list flex>
                    <md-list-item ng-repeat="callbackUrl in github.callbackUrls track by $index">
                        <p>{{ callbackUrl }}</p>
                        <md-button class="md-warn" ng-click="github.removeUrl($index)">remove</md-button>
                    </md-list-item>
                </md-list>
            </div>
        </form>
